        ...
        for i, tier in enumerate(self.secondary_tiers):
            for completed_job in tier.get_finished_jobs():
                ...
                if transfer_job.is_promotion:
                    ...
                    if completed_job.successful_keys:
                        self._promoted_keys.update(completed_job.successful_keys)
                    elif completed_job.success:
                        self._promoted_keys.update(job_metadata.keys)
                else:
